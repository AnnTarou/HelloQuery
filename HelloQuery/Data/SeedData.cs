                ...
                if (!context.Lesson.Any())
                {
                    var lessons = new Lesson[]
                    {
                        ...
                        new Lesson{ Category = "基本的な演算",
                                    ...
                                    Question = "出版日が1907年1月1日以前のタイトル、著者、出版日を取得してください。",
